...
##            var_fileheader = raw_input("Enter animal ID and day (e.g.: mouseB_day1): ")
        ...
        print running
        if GPIO.input(24) ==1 and running == 0:
            running = 1
            break;
##    if (str(var) == 'n'):
...
while True:
    if(GPIO.input(24) ==1): # this would be the trigger input pin (may need to be ==0 depending on trigger input
        ...
        img_filename = "pic_"+time_file+".jpg"
        vid_filename = "vid_"+time_file+".h264"
        mp4_filename = "vid_"+time_file+".mp4"
